...
class Book(models.Model):
    ...
    get_from1=models.CharField(max_length=255,null=True)
    get_from2=models.CharField(max_length=255,null=True)
    get_from3=models.CharField(max_length=255,null=True)
