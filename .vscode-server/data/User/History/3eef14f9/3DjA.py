...
def book(request, book_id):
    ...
    return render(request, 'book-info.html',{"book":book,"booksproviders":booksprovider, "accomplishments":accomplishments,"slideshow":Slideshow,"intros":Intro,"avs":Av,})