...
def book(request, book_id):
    ...
    return render(request, 'book-info.html',{"book":book,"providers":booksprovider, "accomplishments":accomplishments,"slideshows":slideshow,"intros":intro}) 