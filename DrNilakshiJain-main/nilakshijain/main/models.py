...
class Book(models.Model):
    ...
    getfrom1_link=models.URLField(max_length=255,null=True)
    getfrom2=models.CharField(max_length=255,null=True)
    getfrom2_link=models.URLField(max_length=255,null=True)
    getfrom3=models.CharField(max_length=255,null=True)
    getfrom3_link=models.URLField(max_length=255,null=True)
